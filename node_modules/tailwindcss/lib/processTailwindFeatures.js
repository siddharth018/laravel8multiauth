...
function _default(getConfig) {
  return function (css) {
    ...
    if (configChanged) {
      ...
      processedPlugins = (0, _processPlugins.default)([...(0, _corePlugins.default)(config), ...[(0, _featureFlags.flagEnabled)(config, 'darkModeVariant') ? _darkModeVariantPlugin.default : () => {}], ...config.plugins], config);
